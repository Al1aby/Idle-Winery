...
export const GRAPE_VARIETIES = [
  { id:"chardonnay", name:"Chardonnay", emoji:"🍇", unlockCost:0,    grapeValue:1,  wineMultiplier:1,   growTime:8,  prem:false },
  { id:"merlot",     name:"Merlot",     emoji:"🍷", unlockCost:500,  grapeValue:2.5,wineMultiplier:2,   growTime:14, prem:false },
  { id:"riesling",   name:"Riesling",   emoji:"🌿", unlockCost:2000, grapeValue:5,  wineMultiplier:3.5, growTime:22, prem:false },
  { id:"cabernet",   name:"Cabernet",   emoji:"🫐", unlockCost:8000, grapeValue:10, wineMultiplier:6,   growTime:35, prem:false },
  { id:"champagne",  name:"Champagne",  emoji:"🥂", unlockCost:0,    grapeValue:18, wineMultiplier:12,  growTime:55, prem:true  },
  { id:"icewine",    name:"Ice Wine",   emoji:"❄️",  unlockCost:0,    grapeValue:25, wineMultiplier:18,  growTime:80, prem:true  },
  { id:"barolo",     name:"Barolo",     emoji:"🏆", unlockCost:0,    grapeValue:35, wineMultiplier:24,  growTime:110,prem:true  },
];

export const UPGRADE_DEFS = {
  vineYield:  { label:"Vine Yield",   icon:"🍇", desc:"More grapes per tap",     baseCost:50,  costMult:1.4, baseVal:1, valPerLevel:1   },
  pressSpeed: { label:"Press Speed",  icon:"⚙️",  desc:"Faster grape pressing",   baseCost:80,  costMult:1.5, baseVal:0, valPerLevel:2   },
  cellarSpeed:{ label:"Cellar Speed", icon:"🪣", desc:"Faster fermentation",     baseCost:120, costMult:1.6, baseVal:0, valPerLevel:5   },
  winePrice:  { label:"Wine Quality", icon:"💎", desc:"Higher per-bottle price", baseCost:200, costMult:1.7, baseVal:1, valPerLevel:0.4 },
};

export const STAFF_DEFS = {
  harvester:{ name:"Vineyard Worker", desc:"Auto-harvests grapes",   emoji:"👨‍🌾", baseCost:500,  costMult:3,   maxLvl:3, rates:[0.4,0.9,1.8]   },
  presser:  { name:"Press Operator",  desc:"Keeps presses running",  emoji:"⚙️",  baseCost:800,  costMult:3,   maxLvl:3, mults:[1,2,3]          },
  cellarMgr:{ name:"Cellar Manager",  desc:"Keeps barrels going",    emoji:"🪣", baseCost:1200, costMult:3,   maxLvl:3, mults:[1,2,3]          },
...
export const SEASONS_DATA = [
  { id:"spring", label:"Spring", emoji:"🌸", hMult:1.2, gMult:1.2, wBonus:0    },
  { id:"summer", label:"Summer", emoji:"☀️",  hMult:1.3, gMult:1.0, wBonus:0.1  },
  { id:"autumn", label:"Autumn", emoji:"🍂", hMult:1.6, gMult:0.85,wBonus:0.25 },
  { id:"winter", label:"Winter", emoji:"❄️",  hMult:0.7, gMult:0.5, wBonus:0.4  },
];

export const EVENTS_LIST = [
  { id:"e1", name:"Harvest Festival", desc:"Harvest 200 grapes",  type:"harvest", target:200, secs:360, reward:{money:600,  fame:5  } },
  { id:"e2", name:"Red Wine Gala",    desc:"Sell 20 bottles",     type:"sell",    target:20,  secs:480, reward:{money:1200, fame:8  } },
  { id:"e3", name:"Press Blitz",      desc:"Complete 10 presses", type:"press",   target:10,  secs:480, reward:{money:700,  fame:6  } },
  { id:"e4", name:"Export Rush",      desc:"Complete 2 exports",  type:"export",  target:2,   secs:900, reward:{money:1800, fame:15 } },
];
